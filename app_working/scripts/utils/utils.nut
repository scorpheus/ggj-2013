...
function GetIntersection( /*float*/ fDst1, /*float*/ fDst2, /*CVec3*/ P1, /*CVec3*/ P2) 
{
	if ( (fDst1 * fDst2) >= 0.0) 
		return 0;
	if ( fDst1 == fDst2) 
...
function InBox( /*CVec3*/ Hit, /*CVec3*/ B1, /*CVec3*/ B2, /*const int*/ Axis) {
...
function CheckLineBox( /*CVec3*/ B1, /*CVec3*/ B2, /*CVec3*/ L1, /*CVec3*/ L2)
{
local Hit = 0
...
if (L1.x > B1.x && L1.x < B2.x &&
	...
	Hit = GetIntersection( L1.x-B1.x, L2.x-B1.x, L1, L2)
if (Hit && InBox( Hit, B1, B2, 1 ))
	return Hit

	Hit = GetIntersection( L1.y-B1.y, L2.y-B1.y, L1, L2)
if (Hit &&  InBox( Hit, B1, B2, 2 ))
	return Hit
	Hit = GetIntersection( L1.z-B1.z, L2.z-B1.z, L1, L2)
if (Hit &&  InBox( Hit, B1, B2, 3 ))
	return Hit
